...
class BP_Group_Clone_Functions {
    ...
    // Verify nonce
    if (!isset($_POST['_wpnonce']) || !wp_verify_nonce($_POST['_wpnonce'], 'bp_group_clone')) {
    ...
    public function log_ajax_error() {
        ...
        $error_message = sprintf(
            ...
            sanitize_text_field($error_details['textStatus']),
            sanitize_text_field($error_details['errorThrown']),
