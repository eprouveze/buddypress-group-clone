...
class BP_Group_Clone_Functions {
    ...
    /**
     * BP_Group_Clone_Functions constructor.
     */
    public function __construct() {
        add_action( 'bp_setup_nav', array( $this, 'add_admin_nav_item' ) );
        add_action( 'admin_init', array( $this, 'process_clone' ) );
        add_action( 'admin_footer-buddypress_page_bp-groups', array( $this, 'add_admin_button' ) );
    }
    ...
    /**
     * Add admin button to the BuddyPress Groups page.
     */
    public function add_admin_button() {
        // Add your button HTML or functionality here
        echo '<button class="button">Clone Group</button>';
    }

    /**
     * Add a new navigation item to the BuddyPress admin area.
     */
    public function add_admin_nav_item() {
        bp_core_new_nav_item(array(
            'name' => __('Clone Group', 'bp-group-clone'),
            'slug' => 'clone-group',
            'position' => 81,
            'screen_function' => array($this, 'clone_group_screen'),
            'parent_url' => trailingslashit(bp_get_groups_directory_permalink()) . 'admin/',
            'parent_slug' => 'groups'
        ));
    }

    /**
     * Process the group cloning functionality.
     */
    public function process_clone() {
        // Add your group cloning logic here
        // This method will be called when the "Clone Group" admin action is triggered
        echo 'Processing group cloning...';
    }

    /**
     * Callback function for the Clone Group admin screen.
     */
    public function clone_group_screen() {
        // Add your clone group functionality here
        echo 'Clone Group screen';
    }
}
